...
//****************************************  
 ...
 function initMap() {
   ...
   if (mapDiv.length) {  
     var myOptions = {
         zoom: 13,
         center: new google.maps.LatLng(50.464207, 30.519949),
         mapTypeId: google.maps.MapTypeId.ROADMAP
     };
     var map = new google.maps.Map(document.getElementById('gmap_canvas'), myOptions);
     var marker = new google.maps.Marker({
         map: map,
         position: new google.maps.LatLng(50.464207, 30.519949)
     });
     var infowindow = new google.maps.InfoWindow({
         content: '<strong>Timberland Ukraine</strong><br>Головний офіс<br>'
     });
